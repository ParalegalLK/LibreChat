...
const ChatForm = memo(function ChatForm({
  ...
  const recorderDisabled =
    disableInputs || isNotAppendable || answerMode.composerLocked || !speechSettingsInitialized;
  ...
  }, [recorder.isListening, recorder.startRecording, recorder.stopRecording, recorderDisabled]);
              ...
              >
                ...
                <BadgeRow
                  showEphemeralBadges={
                    ...
                    !isAssistantsEndpoint(endpoint) &&
                    endpointKey !== 'paralegal.lk' &&
                    endpointKey !== 'dl-f-de-saram-chat'
                  }
